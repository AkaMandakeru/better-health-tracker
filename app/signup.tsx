...
const SignUpWithLeftBackground = () => {
  ...
  const { signUp, signInWithGoogle, signInWithApple, signInWithFacebook, signInWithInstagram, devMockLogin } = useSession();
        ...
        render: ({ id }) => {
          return (
            <Toast nativeID={id} variant="accent" action="error">
              <ToastTitle>{error.message || "Sign up failed. Please try again."}</ToastTitle>
            </Toast>
          );
        },
      });
    ...
    try {
      ...
      toast.show({
        ...
        render: ({ id }) => {
          return (
            <Toast nativeID={id} variant="accent" action="error">
              <ToastTitle>{error.message || `${provider} sign up failed. Please try again.`}</ToastTitle>
            </Toast>
          );
        },
      });
